...
type
  TWaitDialog = class(TFrame)
    ...
    procedure rctMessageBGClick(Sender: TObject);
  private
...
procedure TWaitDialog.rctMessageBGClick(Sender: TObject);
begin
  TWaitDialog.Hide;
end;
...
class procedure TWaitDialog.ReleaseInstance;
begin
